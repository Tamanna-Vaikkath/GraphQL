...
from pipeline.hyde_expander import LLMHyDEExpander
...
from utils.llm_client import GPTClient   # ← adapter that exposes .complete()
...
class NLQPipeline:
    def __init__(self, cfg: Optional[Config] = None):
        ...
        self.expander = LLMHyDEExpander(llm)          # ← adapter, not cfg
